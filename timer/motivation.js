const motivationalMessages = [
    ...
    "You got this.",
    "One day closer to the finish line.",
    "Keep moving. Heroes don't quit when things get difficult.",
    "You don't need perfect conditions to make progress.",
    "Do the best you can with the day you've been given.",
    ...
    "The grind won't last forever. Keep swinging forward.",
    "Bad days happen. Keep climbing anyway.",
    "Sometimes surviving the day is the win.",
    "Keep your head up. The skyline looks better from higher up.",
    "You can't control every setback, but you can control your next step.",
    ...
    "Today's problems are temporary. Your goals aren't.",
    ...
    "The struggle is temporary. The achievement lasts.",
    "Keep swinging. The destination is getting closer.",
    "Your future self is cheering for you right now.",
    "The hardest part is often showing up. You already did that.",
    ...
    "Heroes aren't fearless. They act despite fear.",
    "Freedom is approaching one workday at a time."
];
