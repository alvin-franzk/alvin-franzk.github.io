...
"🏁 One day closer to the finish line.",
    ...
    "🇨🇴 Tranquilo, que todo llega a su tiempo.",
    "💪 Usted puede con eso y con mucho más.",
    "☀️ Hoy toca seguir adelante.",
    "🚶‍♂️ Paso a paso también se llega lejos.",
    "🌱 Lo importante es no dejar de avanzar.",
    "🔥 No se rinda, que ya falta menos.",
    "⭐ Lo mejor todavía está por venir.",
    "💙 Sea buena gente. Nunca sabe por lo que está pasando alguien.",
    "🤝 Un acto de amabilidad puede cambiarle el día a una persona.",
    "🌈 Después de los días difíciles vienen tiempos mejores.",
    "🏆 Cada esfuerzo cuenta, así no se vea de inmediato.",
    "🚀 Poco a poco se logra todo.",
    "🌟 Confíe en usted mismo. Ya ha superado mucho.",
    "💡 A veces solo hay que seguir intentando.",
    "🫶 Sea amable siempre que pueda.",
    "🌅 Mañana será otro día y otra oportunidad.",
    "🎯 Concéntrese en el siguiente paso.",
    "⚡ Usted es más fuerte de lo que cree.",
    "🏔️ Las metas grandes también se alcanzan paso a paso.",
    "💯 Ya ha sobrevivido todos sus días difíciles hasta ahora.",
